import numpy as np
# CV 2019/11/25: adds the barotropic component to the modes, i.e., [1, 1, 1,...,1]

# CV 2016/12/01 : from matlab to python.  
#                 changes pressure to depth compared to the original 
