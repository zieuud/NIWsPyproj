...
plt.subplot(2, 3, 4)
plt.pcolormesh(freq, depth, spp, norm=LogNorm(vmin=1e-5, vmax=1e0))
plt.xscale('log')
plt.xlim([1e-6, 1e-4])
plt.ylim([-2000, 0])
...
plt.subplot(2, 3, 5)
plt.pcolormesh(freq, depth, snn, norm=LogNorm(vmin=1e-5, vmax=1e0))
plt.xscale('log')
plt.xlim([1e-6, 1e-4])
plt.ylim([-2000, 0])
...
plt.subplot(2, 3, 6)
plt.pcolormesh(freq, depth, snn/spp, norm=LogNorm(vmin=1e-2, vmax=1e2), cmap='coolwarm')
plt.xscale('log')
plt.xlim([1e-6, 1e-4])
plt.ylim([-2000, 0])
