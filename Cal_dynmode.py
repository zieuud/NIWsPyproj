...
wmodes, pmodes, ce = dynmodes(np.squeeze(Nmean[:180]), depth[:180], nmodes)
# for t in range(nt):
...
# np.savez(r'ADCP_uv_5modes.npz', u_mod=u_mod, v_mod=v_mod, KE_mod=NIKE)
...
plt.savefig(r'figures\time-averaged mode structure.jpg', dpi=300)
plt.show()
print('c')
