...
data1 = np.load(r'ReanaData/WOA23_pmodes_mean.npz')
pmodes = data1['pmodes']
Nsq = data1['Nsq']
ze = data1['ze']
...
for i in range(11):
    ...
    if i == 0:
        ...
        ax.text(np.nanmin(pmodes[i, :]), -1800, 'mode {}'.format(i), fontsize=16)
        ax.set_ylim(-2000, 0)

plt.savefig(r'figures/fig_6_VerticalModeStructure.jpg', dpi=300, bbox_inches='tight')
